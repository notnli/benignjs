...
getAshiatoData:function(){function d(a){return b.status.isTimeout?(b.displayDefaultContents(),!1):(clearTimeout(g),a.code===c||a.num===c?(b.displayDefaultContents(),!1):"0"!=a.code?("1"!=a.code&&"8"!=a.code||b.regImpressionCode(b.settings.common.impnodisp),b.displayDefaultContents(),!1):a.items.length<1?(b.displayDefaultContents(b.settings.common.impnodisp),!1):(b.props.ashiato.items=a.items.filter(function(a){return/^https?:\/\/item.rakuten.co.jp/.test(a.itemurlfull)}).map(function(a){return{
...
eobj:b.eobj.ashiato,items:b.props.ashiato.items,events:{beforeFirstRender:function(a,b){b.eobj.ashiato.itemsDisplay.show()},afterSlide:function(a,b){b.props.reco.visitedPages=[],b.getCachedRecoData(a)||b.getRecoData(a)}}}),b.getRecoData(0),void e()))))}var g;b.status.isTimeout=!1;try{if(g=setTimeout(function(){b.status.isTimeout=!0,b.displayDefaultContents()},b.settings.common.ajaxtimer),b.settings.ashiato.mockdata){return void d(a.JSON.parse(b.settings.ashiato.mockdata))}f.ajax({
url:b.settings.ashiato.url,cache:!1,dataType:"jsonp",scriptCharset:"euc-jp",timeout:b.settings.common.ajaxtimer,success:function(a){d(a)},error:function(a,c,d){b.displayDefaultContents()}})}catch(a){return void b.displayDefaultContents()}},getCachedRecoData:function(a){if(!1===a||0==b.props.reco.items.length)return!1;var d=b.props.reco.items[a];return d!=c&&0!=d.length&&(b.displayRecoLoading(),b.displayRecoData(a),!0)},getRecoData:function(d){function e(a,d){
