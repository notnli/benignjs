...
(function(f, h) {
	...
	function v(a, b, c, e) {
		...
		a.removeEventListener(b, c, e || !1) : "function" == typeof a.P && a.P("on" + b, c)
	}
	function m(a) {
		try {
	...
	if ("IntersectionObserver" in f &&
	"IntersectionObserverEntry" in f && "intersectionRatio" in f.IntersectionObserverEntry.prototype)
