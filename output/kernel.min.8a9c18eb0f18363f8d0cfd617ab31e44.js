...
if(!CQ_Analytics.DemandbaseStore.data){var d=document.location.protocol,c=CQ.shared.HTTP.getParameter(document.location.href,"ipOverride"),b=d+"//api.company-target.com/api/v2/ip.json?token=ISTSgTgnTaAqQ1ubW6LBngVUhd6V0uEuIo36F2qy"+((c!=""&&c!=null)?"&query="+c:"");
