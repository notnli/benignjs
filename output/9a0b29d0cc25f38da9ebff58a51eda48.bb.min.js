...
BB.banned_img_hosts_reg = /keep4u|centrkino|flashrelease|hidebehind|imagebanana|imageshack|imagevenue|imgur|interfoto|ipicture|photobucket|tinypic|(youpic|upimg|sendpic|radikal|hq\-video)\.ru|(rimg|ifotki)\.info/i;
...
(function() {
 ...
 FileTree.prototype = {
  ...
  highlight_fname_errors: function(i) {
   ...
   } else if (/\.(wav|url|torrent|scr)$|Thumbs\.db$/i.test(t)) {
    i.className = 'ext-group-1';
